...
export const TramiteEstadoNoVitacora = ['APROBANDO'];
...
export const CLASIFICADOR_INACTIVO = 'CIIU';
...
export const PublicacionEstado = {
  PUBLICADO: '1',
  PAGADO: '2',
};

export const MATRICULA_ACTUALIZADO_VIGENTE = '0';

export const CAMPO_REQUIRED = 'required';
